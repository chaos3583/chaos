...
package com.chaos.webapi.taskConfig;
...
public class SimpleJobConfig {
  ...
  //@Bean(initMethod = "init")
  //public JobScheduler pofitLossOrderJobScheduler(final ProfitLossOrderJob pofitLossOrderJob, @Value("${pofitLossOrderJob.cron}") final String cron, @Value("${pofitLossOrderJob.shardingTotalCount}") final int shardingTotalCount,
//                                       @Value("${pofitLossOrderJob.shardingItemParameters}") final String shardingItemParameters) {
  //  return new SpringJobScheduler(pofitLossOrderJob, regCenter, getLiteJobConfiguration(pofitLossOrderJob.getClass(), cron, shardingTotalCount, shardingItemParameters), jobEventConfiguration);
  //}
